  ...
  (n.n = function(t) {
    ...
    (function() {
      ...
      for (var y = [], S = 0; S < 256; ++S)
        y[S] = (S + 256).toString(16).substr(1);
      ...
      function L(t, e, n) {
        for (var r = 0, i = e.length; r < i; ++r) {
          var a = e[r];
          if (C(a) || 'function' == typeof a)
            for (var o = Object.keys(a), s = 0, c = o.length; s < c; s++) {
              var u = o[s],
                f = a[u];
              n && C(f)
                ? (C(t[u]) || (t[u] = Array.isArray(f) ? [] : {}),
                  L(t[u], [f], !1))
                : (t[u] = f);
            }
        }
      ...
      function N(t) {
        return L(t, h.call(arguments, 1), !1);
      }
      function I(t) {
        return L(t, h.call(arguments, 1), !0);
      }
      function j(t) {
        return void 0 === t;
      }
      ...
      function tt(t) {
        ...
        if (e && e.addEventListener)
          var n = $(e, 'open', function() {
              return function(t, e) {
                return (
                  t[J] || ((t[Z] = e[0]), (t[G] = e[1]), (t[X] = !1 === e[2])),
                  n.apply(t, e)
                );
              };
            }),
        ...
        function i(e, n) {
          e.state !== Y && ((e.state = Y), (e.data.status = n), t(Y, e));
        }
      }
      function et(t) {
            ...
            case 'resource':
              n = (function(t) {
                var e = t.entry,
                  n = t.url,
                  r = yt(new ht(n));
                return { http: { url: n, response: mt(e) }, destination: r };
              })(e);
              break;
            case 'hard-navigation':
              n = (function(t) {
                var e = t.url;
                return { destination: yt(new ht(e)) };
              })(e);
          }
          t.addContext(n);
        }
      ...
      function bt(t, e) {
        ...
        if (t.type === W && U()) {
          ...
          o && o.length > 0 && (a = { response: mt(o[0]) });
        }
        t.addContext(i, a, r);
      }
      var wt = {
      ...
      var Ft = (function() {
          ...
          return (
            (e.createErrorDataModel = function(t) {
              ...
              var f = this._transactionService.getCurrentTransaction(),
                ...
                h = {
                  id: b(),
                  culprit: n,
                  exception: { message: o, stacktrace: e, type: s },
                  context: v,
                };
              return (
                f &&
            ...
            (e.logError = function(t) {
              var e = {};
              return (
                'string' == typeof t ? (e.message = t) : (e.error = t),
                this.logErrorEvent(e)
              );
            }),
          ...
          if (n >= r && i >= n && a >= i) {
            ...
            return (
              Mt.forEach(function(r) {
                ...
                i &&
                  i >= n &&
                  (D(t) ? (o[r] = parseInt(i - e)) : (o[r] = parseInt(i - n)));
              }),
              o
            );
          }
        ...
        return new v(function(n, r) {
          ...
          (u.onreadystatechange = function() {
            if (4 === u.readyState) {
              var t = u.status,
                i = u.responseText;
              et(t) ? n(u) : r({ url: e, status: t, responseText: i });
            }
          }),
            (u.onerror = function() {
              var t = u.status,
      ...
      var Xt = (function() {
        ...
        return (
          ...
          (e.ndjsonMetricsets = function(t) {
            return t
              .map(function(t) {
                return Pt.stringify({ metricset: t });
              })
              .join('');
          }),
      ...
      var Zt,
        Yt = (function() {
          ...
          return (
            ...
            (e.setLocalConfig = function(t, e) {
              if (t) {
                if (e) t = Gt({}, this.getLocalConfig(), t);
        ...
        Wt =
          (((Zt = {}).ConfigService = function() {
            return new Yt();
          }),
          (Zt.LoggingService = function() {
            return new Qt({ prefix: '[Elastic APM] ' });
          }),
          (Zt.ApmServer = function(t) {
          ...
          return (
            ...
            (e.getService = function(t) {
              ...
              return 'string' == typeof t
                ? (this.instances[t] ||
                    ('function' == typeof Wt[t] &&
                      (this.instances[t] = Wt[t](this))),
                  this.instances[t])
                : Array.isArray(t)
                ? t.map(function(t) {
          ...
          return (
            (e.init = function(t) {
              ...
              void 0 === t && (t = {}),
                ...
                t.history && ot.observe('history', this.getHistorySub()),
                t.xmlhttprequest &&
                  ot.observe('xmlhttprequest', this.getXHRSub()),
                t.fetch && ot.observe('fetch', this.getFetchSub());
            }),
            ...
            (e.extractDtHeader = function(t) {
              ...
              if (t)
                return (function(t) {
                  var e = /^([\da-f]{2})-([\da-f]{32})-([\da-f]{16})-([\da-f]{2})$/.exec(
                    t,
                  );
                  if (e) {
                    var n = '00' !== e[4];
        ...
        ee = (function() {
          ...
          return (
            ...
            (e.addContext = function() {
              ...
              0 !== e.length &&
                (this.ensureContext(),
                I.apply(void 0, [this.context].concat(e)));
            }),
            (e.end = function(t) {
              this.ended ||
                ((this.ended = !0), (this._end = P(t)), this.callOnEnd());
            }),
      ...
      var re = (function(t) {
          ...
          return (
            ...
            (r.prototype.end = function(e, n) {
              t.prototype.end.call(this, e), _t(this, n);
            }),
            r
          );
        })(ee),
      ...
      function oe(t, e) {
        ...
        return {
          ...
          samples: {
            ...
            'span.self_time.sum.us': ae(1e3 * a),
          },
        };
      }
      function se(t, e) {
      ...
      var ce = (function(t) {
          ...
          return (
            ...
            (i.canReuse = function() {
              ...
              return (
                !!this.options.canReuse && !this.ended && A() - this._start < t
              );
            }),
              ...
              this.breakdownTimings = (function(t, e) {
                ...
                if (i === W && e)
                  for (var s = 0; s < ie.length; s++) {
                    ...
                    0 !== u &&
                      null != u &&
                      n.push(oe(o, { details: { type: c[2] }, duration: u }));
                  }
                else {
                  var f = (function(t) {
                    var e = {},
      ...
      function fe(t, e) {
        ...
        if (s) {
          ...
          (ue.lcp = c), (a.marks.largestContentfulPaint = c);
        }
        var u = m.timing,
        ...
        if (d) {
          ...
          (ue.fcp = l), (a.marks.firstContentfulPaint = l);
        }
        var p = (function(t) {
          var e = t[0];
          if (e) {
            var n = e.startTime,
              r = e.processingStart,
              i = new re('First Input Delay', 'first-input', { startTime: n });
            return i.end(r), i;
          }
        })(t.getEntriesByType('first-input'));
        return (
          p && ((ue.fid = p.duration()), a.spans.push(p)),
          (function(t) {
            t.forEach(function(t) {
              ...
              if (
                ...
                ue.tbt.start = Math.min(ue.tbt.start, n);
                var i = r - 50;
                i > 0 && (ue.tbt.duration += i);
              }
            });
          })(i),
          (function(t) {
            t.forEach(function(t) {
              !t.hadRecentInput &&
                t.value &&
                ((t.startTime - ue.cls.firstEntryTime > 5e3 ||
                  t.startTime - ue.cls.prevEntryTime > 1e3) &&
                  ((ue.cls.firstEntryTime = t.startTime),
                  (ue.cls.currentSessionScore = 0)),
                (ue.cls.prevEntryTime = t.startTime),
                (ue.cls.currentSessionScore += t.value),
                (ue.cls.score = Math.max(
                  ue.cls.score,
                  ue.cls.currentSessionScore,
                )));
            });
      ...
      var de = (function() {
        ...
        return (
          (e.start = function(t) {
            try {
              if (!z(t)) return;
              this.po.observe({ type: t, buffered: !0 });
            } catch (t) {}
          }),
          (e.stop = function() {
            this.po.disconnect();
      ...
      function ge(t) {
        if (t.captureTimings) {
          ...
          if (t.type === W) {
            ...
            var r = m.timing;
            (function(t, e, n, r) {
              for (var i = [], a = 0; a < pe.length; a++) {
                var o = t[pe[a][0]],
                  s = t[pe[a][1]];
                if (le(o, s, n, r, e)) {
                  var c = new re(pe[a][2], 'hard-navigation.browser-timing'),
                    u = null;
                  'requestStart' === pe[a][0] &&
              ...
              return i;
            })(r, D(r) ? r.redirectStart : r.fetchStart, 0, e).forEach(function(
              e,
            ) {
              (e.traceId = t.traceId),
                (e.sampled = t.sampled),
              ...
              for (var i = [], a = 0; a < t.length; a++) {
                ...
                -1 !== Q.indexOf(s) &&
                  ...
                  ((('xmlhttprequest' === s || 'fetch' === s) &&
                    (/intake\/v\d+\/rum\/events/.test(c) || he(u, e))) ||
                    (le(u, f, n, r) && i.push(ve(t[a]))));
              }
              return i;
            })(m.getEntriesByType('resource'), ut.bootstrapTime, i, e).forEach(
              function(e) {
      ...
      var me = (function() {
        function t(t, e) {
          ...
          (this._config = e),
            ...
            (this.recorder = new de(function(t) {
              var e = n.getCurrentTransaction();
              if (e && e.captureTimings) {
                var r,
                  i = e.type === W,
                  a = fe(t, { isHardNavigation: i, trStart: i ? 0 : e._start }),
                  o = a.spans,
                  s = a.marks;
        ...
        return (
          ...
          (e.createOptions = function(t) {
            var e = this._config.config,
              n = N({ transactionSampleRate: e.transactionSampleRate }, t);
            return (
              n.managed &&
                (n = N(
                  {
          ...
          (e.handleTransactionEnd = function(t) {
            ...
            return v.resolve().then(
              function() {
                ...
                if (
                  !(
                    ut.lastHiddenStart >= t._start ||
                    e.shouldIgnoreTransaction(r) ||
                    'temporary' === i
                  )
                ) {
                  if (i === W) {
                    ...
                    if (
                      ...
                      c.duration > 0 &&
                        t.spans.push(
                          ((d = (f = c).start),
                          (l = f.duration),
                          (p = new re('Total Blocking Time', 'longtask', {
                            startTime: d,
                          })).end(d + l),
                          p),
                        ),
                  ...
                  bt(t, v), e._config.events.send('transaction:end', [t]);
                }
              },
              function(t) {
                0;
      ...
      function ye() {
        return (
          (Wt.TransactionService = function(t) {
            var e = t.getService(['LoggingService', 'ConfigService']),
              n = e[0],
              r = e[1];
            return new me(n, r);
          }),
          (Wt.PerformanceMonitoring = function(t) {
            var e = t.getService([
                'ApmServer',
                'ConfigService',
                'LoggingService',
              ...
              i = e[2],
              a = e[3];
            return new te(n, r, i, a);
          }),
          (Wt.ErrorLogging = function(t) {
            var e = t.getService([
                'ApmServer',
                'ConfigService',
                'TransactionService',
      ...
      function Se(t, e) {
        ...
        if (n) {
          var r = t.observeEvent('queue:add_transaction', function() {
            t.dispatchEvent('queue:flush'), (ut.lastHiddenStart = A()), r();
          });
          n.end();
        } else t.dispatchEvent('queue:flush'), (ut.lastHiddenStart = A());
      }
      function _e(t) {
        var e = function(e) {
      ...
      var be = (function() {
        ...
        return (
          ...
          (e.init = function(t) {
            ...
            if (this.isEnabled() && !this._initialized) {
              ...
              var n = this.serviceFactory.getService([
                ...
                i = n[1],
                a = n[2];
              r.setVersion('5.15.0'), this.config(t);
              ...
              if ((i.setLevel(o), r.get('active'))) {
                ...
                var u = function() {
                  return s[W] && e._sendPageLoadMetrics();
                };
                r.get('centralConfig')
          ...
          (e._sendPageLoadMetrics = function() {
            var t = this.startTransaction(void 0, W, {
              managed: !0,
              canReuse: !0,
            });
            if (t) {
