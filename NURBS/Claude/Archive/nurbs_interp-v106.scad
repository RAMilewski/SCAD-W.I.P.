...
//   6. P = Z · Λ
//
// Falls back to penalized normal equations if S is still singular.
// Returns list of M control points, or undef if both paths fail.
...
function _kkt_solve(R, A, rhs, eps=1e-6) =
    ...
    : // S is singular — fall back to penalized normal equations.
      let(
          mu      = 1e8,
