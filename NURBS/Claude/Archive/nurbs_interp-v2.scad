...
// degree p.  Returns n+1 values [t_0, t_1, ..., t_n] with t_0=0, t_n=1.
// Computed by averaging wrapped parameter values.
...
function _nurbs_interp_closed(points, degree, centripetal) =
    let(
        ...
        params     = _interp_params_closed(points, centripetal),
        // Compute periodic bar knots by averaging
        bar_knots  = _avg_knots_periodic(params, p),
