...
//   extra_pts = number of extra control points to add beyond what data and constraints require.  Extra knots are placed at midpoints of the widest knot spans.  The underdetermined system is solved via null-space method: exact interpolation with minimum control-polygon roughness.  Default: 0
