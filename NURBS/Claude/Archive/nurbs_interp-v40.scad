...
function nurbs_interp_surface(points, degree, method="dynamic", type="clamped",
    ...
    let(
        ...
        has_fe   = !is_undef(flat_edges),
        fe_su    = has_fe ? flat_edges[0] : undef,
        fe_eu    = has_fe ? flat_edges[1] : undef,
        fe_sv    = has_fe ? flat_edges[2] : undef,
        fe_ev    = has_fe ? flat_edges[3] : undef,
    ...
    assert(!has_fe || (is_list(flat_edges) && len(flat_edges) == 4),
           "nurbs_interp_surface: flat_edges must be a 4-element list [start_u, end_u, start_v, end_v]")
