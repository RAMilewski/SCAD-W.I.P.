...
//   to both curve types via the derivs= parameter.  The clamped
...
// Chord-length (or centripetal) parameterization for clamped curves.
...
function nurbs_interp(points, degree, centripetal=false, type="clamped",
    ...
    type == "clamped" ? _nurbs_interp_clamped(points, degree, centripetal,
                                               derivs, start_der, end_der)
  :                     _nurbs_interp_closed(points, degree, centripetal, derivs);
