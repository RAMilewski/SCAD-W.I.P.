...
//   // "centripetal" (blue), "foley" (red), "dynamic" (orange) compared.
//   // For data with sudden direction changes or uneven chord spacing,
//   // "foley" and "dynamic" reduce unwanted oscillations.
//   sharp = [[0,0], [5,40],[6,40], [10,0], [50,0], [55,40],[56,42], [60,0]];
//   color("blue")   stroke(nurbs_curve(nurbs_interp(sharp, 3),                        splinesteps=32), width=0.1);
...
//   color("blue") stroke(
//       nurbs_curve(nurbs_interp(data, 3, start_deriv=[0,1], end_deriv=[0,-1]), splinesteps=32),
//       width=0.3);
