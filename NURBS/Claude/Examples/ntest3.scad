...
nurbs_interp_surface(surf1, 3, u_edges=[4]);
nurbs_interp_surface(surf1, 3, u_edges=[4],flat_edges=1);
nurbs_interp_surface(surf1, 3, u_edges=[3,6],flat_edges=undef);
nurbs_interp_surface(surf1, 2, u_edges=[3,6],flat_edges=undef);
nurbs_interp_surface(surf1, 3, u_edges=[3,6],flat_edges=1);
nurbs_interp_surface(surf1, 3, u_edges=[4],v_edges=5,flat_edges=1);
}
...
nurbs_interp_surface(surf2, 3, u_edges=[4]);
nurbs_interp_surface(surf2, 3, u_edges=[4],flat_edges=1);
nurbs_interp_surface(surf2, 3, u_edges=[3,6],flat_edges=undef);
nurbs_interp_surface(surf2, 2, u_edges=[3,6],flat_edges=undef);
nurbs_interp_surface(surf2, 3, u_edges=[3,6],flat_edges=1);
nurbs_interp_surface(surf2, 3, u_edges=[4],v_edges=5,flat_edges=1);
}
...
nurbs_interp_surface(surf3, 3, u_edges=[4]);
nurbs_interp_surface(surf3, 3, u_edges=[4],flat_edges=1);
nurbs_interp_surface(surf3, 3, u_edges=[3,6],flat_edges=undef);
nurbs_interp_surface(surf3, 2, u_edges=[3,6],flat_edges=undef);
nurbs_interp_surface(surf3, 3, u_edges=[3,6],flat_edges=1);
nurbs_interp_surface(surf3, 3, u_edges=[4],v_edges=5,flat_edges=1);
nurbs_interp_surface(surf3, 3, v_edges=4,flat_edges=1);
}
}
