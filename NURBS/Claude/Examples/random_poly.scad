...
data = regular_ngon(9, 50);


deriv = [undef, undef, undef, undef, undef, undef, undef, undef, undef];
curve = [undef, undef, undef, undef, undef, undef, undef, undef, undef];



debug_nurbs_interp(data, 3, splinesteps=32, type = "closed", show_ctrl=false, color=color1, data_color="red",  method=method1, deriv = deriv, curvature = curve);
