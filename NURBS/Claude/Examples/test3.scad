...
path = nurbs_interp_curve (data, 3, param="centripetal", splinesteps=32);
path2 = nurbs_interp_curve (data, 3, param="dynamic", splinesteps=32);
path3 = nurbs_interp_curve (data, 3, param="length", splinesteps=32);
