...
show_control = true; // [true,false]


xdistribute(100){
 union(){
    debug_nurbs_interp(data1,3, splinesteps=32, show_ctrl=show_control, data_color="black", data_size=1, method=method);
...
xdistribute(100){
 union(){
    debug_nurbs_interp(data1,3, splinesteps=32, show_ctrl=show_control, data_color="black", data_size=1, method=method, type="closed");
