...
length=95.6;
width= (with_xlr && xlr_in_side_low) ? rpi4_width+bottom_thickness*2+32 : rpi4_width+bottom_thickness*2+3;//with_xlr? height+bottom_thickness : 

top_holes_translate = with_xlr && xlr_in_side_low ? 6 : 22;
...
module bottom() {
    ...
    difference() {
        color("red")
        cuboid([length, width, bottom_thickness], rounding = corner_edge_radius, edges = "Z", anchor = CENTER);
       // right_corner();
...
module front() {
    ...
    difference() {
        ...
        color("blue")
        rotate([90,0,0])
        cuboid([length, side_height, bottom_thickness], rounding = corner_edge_radius/2, edges = FWD, anchor = CENTER);   
       // right_corner();
       // left_corner();
    }    
...
module slide_top() {
    ...
    difference() {
        ...
        translate([0, top_holes_translate, height])
        rotate([90,0,0])
